...
<!-- Sidebar/menu -->
<nav class="w3-sidebar  w3-collapse w3-white w3-animate-left" style="z-index:1;width:300px;box-shadow:1px 1px 1px 1px grey" id="mySidebar"><br>
...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:256px;margin-top:43px;">
